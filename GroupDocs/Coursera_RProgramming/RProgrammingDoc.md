...
Suggested that we swap to Wednesday meet ups instead. Next meet-up 20th august
...
Github the R programming Google document
Flic: Upload the .R quiz 1 answers 
Gists -add info about this and how they work since it's helpful for sharing code snippets
Swirl -quite helpful
Share code/link 
...
Git - v1.9.2
RStudio - v0.98.507
32bit R - v3.1.0  (needed to change setting in RStudio global options to use 32bit instead of 64bit R)
Rtools - Rtools31
